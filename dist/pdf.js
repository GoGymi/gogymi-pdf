...
export class PDF {
    ...
    async addEchart(instance, w = 800, h = 500) {
        ...
        img = await new Promise((res) => { img.onload = () => { res(img); }; });
