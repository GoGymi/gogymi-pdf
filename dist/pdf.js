...
export class PDF {
    constructor() {
        ...
        Object.defineProperty(this, "headerImage", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    insertBar(value, maxValue, topLeft, width, config) {
    ...
    insertText(text, topLeft, width, config) {
        console.log(config);
        console.log(topLeft);
    ...
    addImage(img, format, height, width) {
        const SCALE = 3;
    ...
    async addEchart(instance, w = 800, h = 500) {
